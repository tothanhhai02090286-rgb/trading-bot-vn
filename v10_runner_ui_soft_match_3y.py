...
<div class="ui-note">Bản này chỉ sửa decision layer hiển thị: hạ BUY NOW xuống WATCHLIST nếu T+5 âm, tách TOP MUA THẬT / TOP THEO DÕI, thêm V13.5 match mềm RSI/RS20/market/volume/strategy trong 3 năm. Logic lọc gốc và file output không đổi.</div>

<div class="top-card top-green">
<h3>TOP MUA THẬT - ƯU TIÊN CAO</h3>
<p class="full-note">Điều kiện hiển thị: BUY NOW + Risk PASS + T+2/T+5 không âm + lịch sử mạnh/dùng được.</p>
{v134_buy_real_html}
</div>

<div class="top-card top-green">
<h3>TOP THEO DÕI - CHƯA MUA VỘI</h3>
...
<p class="full-note">Match mềm theo RSI zone, RS20 zone, Market regime, Volume zone và Strategy. Phần này chỉ bổ sung thống kê tham khảo, không đổi lệnh gốc.</p>
