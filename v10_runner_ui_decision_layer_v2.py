...
<div class="ui-note">Bản này chỉ sửa decision layer hiển thị: hạ BUY NOW xuống WATCHLIST nếu T+5 âm, tách TOP MUA THẬT và TOP THEO DÕI, làm nổi bật tên mã theo màu. Logic lọc gốc và file output không đổi.</div>
