...
<div class="ui-note">Bản này chỉ sửa decision layer hiển thị: hạ BUY NOW xuống WATCHLIST nếu T+5 âm, tách TOP MUA THẬT / TOP THEO DÕI, thêm V13.5 match mềm và TOP V13.5 dễ xem. Logic lọc gốc và file output không đổi.</div>
