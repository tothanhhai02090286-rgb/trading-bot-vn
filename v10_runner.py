...
# ===== THÊM HÀM repair_mojibake ĐỂ FIX LỖI VỠ FONT =====
def repair_mojibake(text):
    ...
    return result
# ===== KẾT THÚC THÊM HÀM repair_mojibake =====
...
"""
    ...
    if 'combined' in locals() and combined is not None:
        ...
        # ===== THÊM 2 DÒNG NÀY ĐỂ FIX MOJIBAKE =====
        df_debug['AI Reason'] = df_debug['AI Reason'].apply(repair_mojibake)
        df_debug['AI Warning'] = df_debug['AI Warning'].apply(repair_mojibake)
        # ===== KẾT THÚC THÊM 2 DÒNG =====
