...
from v14_ui_final_pro_max_vi import ui_pro_max_css, build_v14_pro_max_main_html
...
def main():
    ...
    try:
        v14_top_lenh_view = build_v14_top_lenh_thuc_chien_vi(v134_ui_view, limit=5)
        v14_top_lenh_html = build_v14_html(v14_top_lenh_view)
    except Exception as e:
        v14_top_lenh_html = f"<p>LOI V14 CHON LENH: {repr(e)}</p>"

try:
    v14_pro_max_html = build_v14_pro_max_main_html(
        v14_df=globals().get("v14_top_lenh_view", pd.DataFrame()),
        v134_df=globals().get("v134_ui_view", pd.DataFrame()),
        v133_df=globals().get("v133_feature_view", pd.DataFrame())
    )
except Exception as e:
    v14_pro_max_html = f"<p>LOI V14 UI PRO MAX: {repr(e)}</p>"
...
<h3>V14 - TOP 5 LENH THUC CHIEN</h3>
{v14_top_lenh_html}

<h3>V14 UI FINAL PRO MAX</h3>
{v14_pro_max_html}
